...
Match3.GameState = {
  ...
  dropReserveBlock: function(sourceRow, targetRow, col) {
    ...
    swapBlocks: function(block1, block2){
        ...
        //when swaping scale 1 back to 1
        ...
        if(!this.isRevesingSwap){
            ...
            if(chains.length > 0){
                ...
                this.isRevesingSwap = true;
                this.swapBlocks(block1, block2);
            }
        }
        else{
             this.isRevesingSwap = false;
            this.clearSelection();
        }
        },this)
    ...
    pickBlock: function(block){
        ...
        if(!this.selectedBlock){
            ...
            //second block you are selecting
            this.targtBlock = block
            //only adjacent blocks can swap
            if(this.board.checkAdjacent(this.selectedBlock, this.targtBlock)){
                //block the ui
                this.isBoardBlocked= true;
                
                //swap block
                this.swapBlocks(this.selectedBlock, this.targtBlock);
            }
            else{
                this.clearSelection();
            }
